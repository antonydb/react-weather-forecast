A simple daily weather forecast application built with React.
It uses [OpenWeatherMap](https://openweathermap.org/api) as it's API.

## Setup
Apply for an API key [OpenWeatherMap](https://openweathermap.org/api) and insert
your key into config.js at the root level of this app.
